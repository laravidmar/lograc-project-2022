{-# LANGUAGE BangPatterns, EmptyDataDecls, EmptyCase,
             ...
             OverloadedStrings #-}
module MAlonzo.Code.Effect.Monad.Indexed where
...
-- Effect.Monad.Indexed.RawIMonad
...
-- Effect.Monad.Indexed.RawIMonad.return
d_return_52 ::
...
-- Effect.Monad.Indexed.RawIMonad._>>=_
d__'62''62''61'__60 ::
  T_RawIMonad_32 ->
  () ->
  () ->
...
du__'60''61''60'__106 v0 v1 v2 v3 v4 v5
  = coe
      ...
      (coe v4)
-- Effect.Monad.Indexed.RawIMonad.join
d_join_118 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonad.rawIApplicative
...
du_rawIApplicative_122 v0
  = coe
      MAlonzo.Code.Effect.Applicative.Indexed.C_RawIApplicative'46'constructor_517
...
-- Effect.Monad.Indexed.RawIMonad._._<$_
d__'60''36'__134 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du__'8859''62'__146 v0 v1 v2 v3 v4 v5 v6 v7
  = coe
      ...
      (coe du_rawIApplicative_122 (coe v0)) v3 v4 v5 v6 v7
-- Effect.Monad.Indexed.RawIMonad._.pure
d_pure_148 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonad._.rawFunctor
d_rawFunctor_150 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonad._.zip
d_zip_152 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonad._.zipWith
d_zipWith_154 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadT
d_RawIMonadT_160 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero
...
d_applicativeZero_186 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Monad.Indexed.RawIMonadZero._._<$_
d__'60''36'__190 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  = let v1 = d_monad_184 (coe v0) in
    \ v2 v3 v4 v5 v6 v7 v8 ->
      coe
        MAlonzo.Code.Effect.Applicative.Indexed.du__'8859''62'__108
        (coe du_rawIApplicative_122 (coe v1)) v4 v5 v6 v7 v8
-- Effect.Monad.Indexed.RawIMonadZero._.join
d_join_214 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero._.pure
d_pure_216 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero._.rawFunctor
d_rawFunctor_218 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero._.rawIApplicative
...
-- Effect.Monad.Indexed.RawIMonadZero._.return
d_return_222 ::
  T_RawIMonadZero_174 -> () -> AgdaAny -> AgdaAny -> AgdaAny
d_return_222 v0 = coe d_return_52 (coe d_monad_184 (coe v0))
-- Effect.Monad.Indexed.RawIMonadZero._.zip
d_zip_224 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero._.zipWith
d_zipWith_226 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadZero._.∅
d_'8709'_230 ::
  T_RawIMonadZero_174 -> () -> AgdaAny -> AgdaAny -> AgdaAny
d_'8709'_230 v0
  = coe
...
-- Effect.Monad.Indexed.RawIMonadPlus
...
d_alternative_252 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Monad.Indexed.RawIMonadPlus._._<$_
d__'60''36'__256 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  = let v1 = d_monad_250 (coe v0) in
    \ v2 v3 v4 v5 v6 v7 v8 ->
      coe
        MAlonzo.Code.Effect.Applicative.Indexed.du__'8859''62'__108
        (coe du_rawIApplicative_122 (coe v1)) v4 v5 v6 v7 v8
-- Effect.Monad.Indexed.RawIMonadPlus._.join
d_join_280 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadPlus._.pure
d_pure_282 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadPlus._.rawFunctor
d_rawFunctor_284 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du_rawFunctor_284 v0
  = let v1 = d_monad_250 (coe v0) in
    coe
      MAlonzo.Code.Effect.Applicative.Indexed.du_rawFunctor_72
      (coe du_rawIApplicative_122 (coe v1))
-- Effect.Monad.Indexed.RawIMonadPlus._.rawIApplicative
...
-- Effect.Monad.Indexed.RawIMonadPlus._.return
d_return_288 ::
  T_RawIMonadPlus_240 -> () -> AgdaAny -> AgdaAny -> AgdaAny
d_return_288 v0 = coe d_return_52 (coe d_monad_250 (coe v0))
-- Effect.Monad.Indexed.RawIMonadPlus._.zip
d_zip_290 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  = let v1 = d_monad_250 (coe v0) in
    \ v2 v3 v4 v5 v6 ->
      coe
        MAlonzo.Code.Effect.Applicative.Indexed.du_zip_146
        (coe du_rawIApplicative_122 (coe v1)) v4 v5 v6
-- Effect.Monad.Indexed.RawIMonadPlus._.zipWith
d_zipWith_292 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Monad.Indexed.RawIMonadPlus._.∅
d_'8709'_298 ::
  T_RawIMonadPlus_240 -> () -> AgdaAny -> AgdaAny -> AgdaAny
d_'8709'_298 v0
  = coe
      ...
      (coe
         ...
         (coe d_alternative_252 (coe v0)))
-- Effect.Monad.Indexed.RawIMonadPlus.monadZero
d_monadZero_300 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
