{-# LANGUAGE BangPatterns, EmptyDataDecls, EmptyCase,
             ...
             OverloadedStrings #-}
module MAlonzo.Code.Effect.Applicative.Indexed where
...
-- Effect.Applicative.Indexed.IFun
d_IFun_24 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () -> MAlonzo.Code.Agda.Primitive.T_Level_14 -> ()
d_IFun_24 = erased
-- Effect.Applicative.Indexed.RawIApplicative
...
-- Effect.Applicative.Indexed.RawIApplicative.pure
d_pure_58 ::
...
-- Effect.Applicative.Indexed.RawIApplicative._⊛_
d__'8859'__66 ::
...
d__'8859'__66 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Applicative.Indexed.RawIApplicative.rawFunctor
d_rawFunctor_72 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  (AgdaAny -> AgdaAny -> () -> ()) ->
  T_RawIApplicative_38 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Effect.Functor.T_RawFunctor_24
...
du_rawFunctor_72 v0 v1 v2
  = coe
      MAlonzo.Code.Effect.Functor.C_RawFunctor'46'constructor_181
      (coe
         (\ v3 v4 v5 ->
            coe
              d__'8859'__66 v0 erased erased v1 v1 v2
              (coe d_pure_58 v0 erased v1 v5)))
-- Effect.Applicative.Indexed.RawIApplicative.RF._<$_
d__'60''36'__84 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du__'8855'__120 v0 v1 v2 v3 v4 v5
  = coe
      ...
      v5
-- Effect.Applicative.Indexed.RawIApplicative.zipWith
d_zipWith_132 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du_zipWith_132 v0 v1 v2 v3 v4 v5 v6
  = coe
      ...
      (coe
         ...
         v5)
      v6
-- Effect.Applicative.Indexed.RawIApplicative.zip
d_zip_146 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIApplicativeZero
...
data T_RawIApplicativeZero_156
  = C_RawIApplicativeZero'46'constructor_7777 T_RawIApplicative_38
                                              (() -> AgdaAny -> AgdaAny -> AgdaAny)
-- Effect.Applicative.Indexed.RawIApplicativeZero.applicative
d_applicative_170 ::
...
d_'8709'_176 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Applicative.Indexed.RawIApplicativeZero._._<$_
d__'60''36'__180 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIApplicativeZero._.pure
d_pure_194 ::
  T_RawIApplicativeZero_156 -> () -> AgdaAny -> AgdaAny -> AgdaAny
d_pure_194 v0 = coe d_pure_58 (coe d_applicative_170 (coe v0))
-- Effect.Applicative.Indexed.RawIApplicativeZero._.rawFunctor
d_rawFunctor_196 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIApplicativeZero._.zip
d_zip_198 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIApplicativeZero._.zipWith
d_zipWith_200 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIAlternative
...
data T_RawIAlternative_210
  = C_RawIAlternative'46'constructor_9171 T_RawIApplicativeZero_156
                                          (() ->
                                           AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny -> AgdaAny)
-- Effect.Applicative.Indexed.RawIAlternative.applicativeZero
...
d_applicativeZero_224 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Applicative.Indexed.RawIAlternative._∣_
d__'8739'__230 ::
...
d__'8739'__230 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Applicative.Indexed.RawIAlternative._._<$_
d__'60''36'__234 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIAlternative._.applicative
...
-- Effect.Applicative.Indexed.RawIAlternative._.pure
d_pure_250 ::
...
d_pure_250 v0
  = coe
      d_pure_58
      (coe d_applicative_170 (coe d_applicativeZero_224 (coe v0)))
-- Effect.Applicative.Indexed.RawIAlternative._.rawFunctor
d_rawFunctor_252 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIAlternative._.zip
d_zip_254 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.RawIAlternative._.zipWith
d_zipWith_256 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.A₁.pure
d_pure_302 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.A₁.rawFunctor
d_rawFunctor_304 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.A₁.zip
d_zip_306 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.A₁.zipWith
d_zipWith_308 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du_zipWith_332 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9
  = coe du_zipWith_132 (coe v0) v4 v5 v6 v7 v8 v9
-- Effect.Applicative.Indexed.Morphism.A₁._<$_
d__'60''36'__360 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du__'8859''62'__372 v0 v1 v2 v3 v4 v5 v6 v7
  = coe du__'8859''62'__108 (coe v0) v3 v4 v5 v6 v7
-- Effect.Applicative.Indexed.Morphism.A₁.pure
d_pure_374 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.Morphism.A₁.rawFunctor
d_rawFunctor_376 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.Morphism.A₁.zip
d_zip_378 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
-- Effect.Applicative.Indexed.Morphism.A₁.zipWith
d_zipWith_380 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
...
du_zipWith_404 v0 v1 v2 v3 v4 v5 v6 v7 v8 v9
  = coe du_zipWith_132 (coe v0) v4 v5 v6 v7 v8 v9
-- Effect.Applicative.Indexed.Morphism.op
d_op_410 ::
...
d_op_410 v0
  = case coe v0 of
      ...
      _ -> MAlonzo.RTE.mazUnreachableError
-- Effect.Applicative.Indexed.Morphism.op-pure
d_op'45'pure_416 ::
  T_Morphism_274 ->
  () ->
  AgdaAny ->
