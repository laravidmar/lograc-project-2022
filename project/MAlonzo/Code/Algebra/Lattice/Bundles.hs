...
d_isBand_40 ::
  T_Semilattice_10 -> MAlonzo.Code.Algebra.Structures.T_IsBand_248
d_isBand_40 v0
  = coe
      MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_1826
      (coe d_isSemilattice_30 (coe v0))
...
d_isMagma_44 ::
  T_Semilattice_10 -> MAlonzo.Code.Algebra.Structures.T_IsMagma_104
d_isMagma_44 v0
  = coe
      MAlonzo.Code.Algebra.Structures.d_isMagma_220
      (coe
...
du_isBand_272 v0
  = let v1 = d_isBoundedSemilattice_256 (coe v0) in
    coe MAlonzo.Code.Algebra.Structures.du_isBand_544 (coe v1)
...
du_isSemilattice_290 v0
  = coe
      MAlonzo.Code.Algebra.Lattice.Structures.du_isSemilattice_2004
      (coe d_isBoundedSemilattice_256 (coe v0))
...
du_idem_358 v0
  = let v1 = d_isBoundedMeetSemilattice_350 (coe v0) in
    coe MAlonzo.Code.Algebra.Structures.d_idem_498 (coe v1)
  ...
  = let v1 = d_isBoundedMeetSemilattice_350 (coe v0) in
    let v2
          = coe
              ...
              (coe v1) in
    let v3
          = MAlonzo.Code.Algebra.Lattice.Structures.d_isBand_1826 (coe v2) in
    let v4
          = MAlonzo.Code.Algebra.Structures.d_isSemigroup_256 (coe v3) in
    let v5 = MAlonzo.Code.Algebra.Structures.d_isMagma_220 (coe v4) in
    coe
      MAlonzo.Code.Relation.Binary.Structures.du_isPartialEquivalence_42
      (coe MAlonzo.Code.Algebra.Structures.d_isEquivalence_112 (coe v5))
