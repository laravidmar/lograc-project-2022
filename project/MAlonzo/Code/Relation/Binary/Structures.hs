...
du__'8799'__514 v0
  = coe
      MAlonzo.Code.Relation.Binary.Consequences.du_tri'8658'dec'8776'_476
...
du__'60''63'__516 v0
  = coe
      MAlonzo.Code.Relation.Binary.Consequences.du_tri'8658'dec'60'_512
      (coe d_compare_512 (coe v0))
...
du_isStrictPartialOrder_536 v0
  = coe
      ...
      (coe
         MAlonzo.Code.Relation.Binary.Consequences.du_trans'8743'tri'8658'resp_700
         (coe d_compare_512 (coe v0)))
...
data T_IsApartnessRelation_556
  = C_IsApartnessRelation'46'constructor_23083 (AgdaAny ->
                                                AgdaAny -> AgdaAny -> AgdaAny)
                                               (AgdaAny ->
                                                AgdaAny ->
                                                AgdaAny ->
...
d_sym_568 v0
  = case coe v0 of
      C_IsApartnessRelation'46'constructor_23083 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
...
d_cotrans_570 v0
  = case coe v0 of
      C_IsApartnessRelation'46'constructor_23083 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
