...
d__'10230'_Respects__220 ::
  ...
  (AgdaAny -> ()) ->
  (AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> ()) -> ()
d__'10230'_Respects__220 = erased
...
d__Respects__232 ::
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> ()) -> ()
d__Respects__232 = erased
-- Relation.Binary.Definitions._Respectsʳ_
d__Respects'691'__238 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> ()) -> ()
d__Respects'691'__238 = erased
-- Relation.Binary.Definitions._Respectsˡ_
d__Respects'737'__248 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> ()) -> ()
d__Respects'737'__248 = erased
-- Relation.Binary.Definitions._Respects₂_
d__Respects'8322'__256 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> (AgdaAny -> AgdaAny -> ()) -> ()
d__Respects'8322'__256 = erased
...
d_Decidable_274 ::
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> ()
d_Decidable_274 = erased
-- Relation.Binary.Definitions.WeaklyDecidable
d_WeaklyDecidable_282 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  () ->
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> ()
d_WeaklyDecidable_282 = erased
-- Relation.Binary.Definitions.DecidableEquality
d_DecidableEquality_292 ::
  MAlonzo.Code.Agda.Primitive.T_Level_14 -> () -> ()
d_DecidableEquality_292 = erased
...
d_Universal_316 ::
  ...
  MAlonzo.Code.Agda.Primitive.T_Level_14 ->
  (AgdaAny -> AgdaAny -> ()) -> ()
d_Universal_316 = erased
-- Relation.Binary.Definitions.NonEmpty
d_NonEmpty_336 a0 a1 a2 a3 a4 a5 = ()
data T_NonEmpty_336 = C_nonEmpty_356 AgdaAny AgdaAny AgdaAny
-- Relation.Binary.Definitions.NonEmpty.x
d_x_350 :: T_NonEmpty_336 -> AgdaAny
d_x_350 v0
  = case coe v0 of
      C_nonEmpty_356 v1 v2 v3 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Definitions.NonEmpty.y
d_y_352 :: T_NonEmpty_336 -> AgdaAny
d_y_352 v0
  = case coe v0 of
      C_nonEmpty_356 v1 v2 v3 -> coe v2
      _ -> MAlonzo.RTE.mazUnreachableError
-- Relation.Binary.Definitions.NonEmpty.proof
d_proof_354 :: T_NonEmpty_336 -> AgdaAny
d_proof_354 v0
  = case coe v0 of
      C_nonEmpty_356 v1 v2 v3 -> coe v3
      _ -> MAlonzo.RTE.mazUnreachableError
